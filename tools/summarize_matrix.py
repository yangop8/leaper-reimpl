...
POLICIES = ["off", "eager_evict", "incremental_warmup", "warm_all", "warm_flush",
            "flush_only", "flush_and_compaction", "leaper", "sst_leaper", "prepop_leaper", "leaper_p1only", "leaper_p2only",
...
LABEL = {"off": "LRU (stock)", "eager_evict": "EagerEvict",
         ...
         "leaper_p1only": "Leaper (evict only)",
         ...
         "sst_leaper": "Leaper (sst warm)", "prepop_leaper": "Leaper (prepopulate)"}
